---
name: writing-fairybox-tests
description: Use when writing or running tests in the fairybox project.
---
# How to Write Tests
...
If you have a REPL available, then running tests in any namespace N should be done as:
